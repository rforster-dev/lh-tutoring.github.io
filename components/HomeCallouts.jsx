        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-8 lg:gap-x-16 lg:items-center">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
            ...
            >
              ...
              <h6 className="mt-2 font-bold">English</h6>
            ...
            >
              ...
              <h6 className="mt-2 font-bold">Maths</h6>
            ...
            >
              ...
              <h6 className="mt-2 font-bold">Science</h6>
            ...
            >
              ...
              <h6 className="mt-2 font-bold">History</h6>
            ...
            >
              ...
              <h6 className="mt-2 font-bold">Geography</h6>
            ...
            >
              ...
              <h6 className="mt-2 font-bold">Design and Technology</h6>
